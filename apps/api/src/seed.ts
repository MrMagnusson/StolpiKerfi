// Seed data — ported verbatim (same customers, projects, units, deals…) from seed() in
// Stólpi Kerfi.dc.html (lines 1001-1136), adapted to relational IDs. Shared by the local CLI
// (prisma/seed.ts, via tsx) and the admin seed endpoint (routes/admin.ts) so both use one
